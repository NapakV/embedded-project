...
(()=>{
    const e = new Error("Cannot find module '@app/api/sendAudioFile'");
...
const Mic = ()=>{
    ...
    if ($[0] !== "d041281303a35788630f813f4c0a8ecc24fe7287745b02be6ef93940ec48b0b3") {
        for(let $i = 0; $i < 20; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d041281303a35788630f813f4c0a8ecc24fe7287745b02be6ef93940ec48b0b3";
    }
...
//# sourceMappingURL=embed_project_embeddedproj_32e893ca._.js.map