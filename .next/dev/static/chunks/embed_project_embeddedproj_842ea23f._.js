...
"[project]/embed/project/embeddedproj/src/app/components/MicIcon.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Mic = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$embed$2f$project$2f$embeddedproj$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(13);
    if ($[0] !== "a8b761b2ea35cefccbb6fc540f43036f5e5d5d2dcb53608556551e58fdc76df5") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a8b761b2ea35cefccbb6fc540f43036f5e5d5d2dcb53608556551e58fdc76df5";
    }
    const [isListening, setIsListening] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$embed$2f$project$2f$embeddedproj$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    let t0;
    if ($[1] !== isListening) {
        t0 = ()=>{
    ...
    const t1 = `bg-primary-200 h-[70px] w-[70px] relative text-primary-800 py-2 px-2 rounded-full shadow-lg hover:shadow-xl transition duration-300 ease-in-out flex items-center justify-center
    ...
    let t3;
    if ($[5] !== t1 || $[6] !== t2) {
        t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$embed$2f$project$2f$embeddedproj$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            className: t1,
            onClick: t2
        }, void 0, false, {
            fileName: "[project]/embed/project/embeddedproj/src/app/components/MicIcon.tsx",
            lineNumber: 40,
            columnNumber: 10
    ...
    let t4;
    if ($[8] !== isListening) {
        t4 = isListening ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$embed$2f$project$2f$embeddedproj$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Mic, "DrvbTpAutob4ffscqUSCDvG+gE8=");
_c = Mic;
var _c;
...
//# sourceMappingURL=embed_project_embeddedproj_842ea23f._.js.map