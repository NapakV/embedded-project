...
"[project]/embed/project/embeddedproj/src/app/components/MicIcon.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Mic = ()=>{
    ...
    const sendGoogleDriveApi = async (audioBlob)=>{
        const formData = new FormData();
        formData.append('file', audioBlob, 'recording.webm');
        console.log('Uploading to Google Drive...');
        try {
            const res = await fetch('POST https://www.googleapis.com/upload/drive/v3/files', {
                method: 'POST',
                // If you need to authenticate, add an Authorization header:
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a6abc594._.js.map